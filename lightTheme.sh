...
# gtk
sed -i "s/gtk-theme-name=.*/gtk-theme-name=\"Catppuccin-Latte-Standard-Blue-Light\"/g" ~/.config/gtk-2.0/gtkrc-2.0
sed -i "s/gtk-icon-theme-name=.*/gtk-icon-theme-name=\"Papirus-Light\"/g" ~/.config/gtk-2.0/gtkrc-2.0
