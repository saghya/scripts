...
# gtk
sed -i "s/gtk-theme-name=.*/gtk-theme-name=\"Catppuccin-Latte\"/g" ~/.gtkrc-2.0
sed -i "s/gtk-icon-theme-name=.*/gtk-icon-theme-name=\"Papirus-Light\"/g" ~/.gtkrc-2.0
sed -i "s/gtk-theme-name=.*/gtk-theme-name=Catppuccin-Latte/g" ~/.config/gtk-3.0/settings.ini
